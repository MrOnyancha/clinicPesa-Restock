...
import DamagedProductForm from '@/components/Forms/Warehouse/DamagedProductForm';
      ...
      <section className="m-4 shadow  border border-slate-200">
        ...
        <div className="p-2 border h-auto m-2 rounded">
          ...
          <div className="mb-4 mt-4 w-full border">
            <Table>
              <TableCaption>A list of your recent damaged products.</TableCaption>
              <TableHeader>
                <TableRow>
